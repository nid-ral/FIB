...
while ($result=mysqli_fetch_array($query)) {
  ...
  <div id="novel" style="background-color:transparent;width:500px;height:300px;margin-left:50px;float:left;border:5px solid transparent;box-shadow: 5px 10px 18px #202020;font-family: 'Kaushan Script','Helvetica Neue',Helvetica,Arial,cursive;margin-top: 70px;">
  <?php
  echo "<br>";
  echo "<h4 style=color:orange;margin-left:10%;>"."Name : ".$result['name']."</h4>";
  echo "<h4 style=color:orange;margin-left:10%;>"."Email : ".$result['email']."</h4>";
  echo "<h4 style=color:orange;margin-left:10%;>"."Contact Number : ".$result['telephone']." INR"."</h4>";
    echo "<h4 style=color:orange;margin-left:10%;>"." Message : ".$result['message']."</h4>";
  ?>
  ...
  echo ">";
  ?>
   <input type="submit" name="bidamount" style="width: 150px;margin-left: 300px;margin-top: 80px;position: absolute;height: 50px;background-color: orange;" value="REMOVE MESSAGE" onclick="location.href='deleteb1.php'">
</form>
<?php
 echo "</div>";
}
